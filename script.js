...
class Boss {
   ...
   update(){
      ...
      this.x += this.speedX;
      this.y += this.speedY;
      //collition detection boss/projectiles
      this.game.projectilesPool.forEach(projectile => {
      ...
      //collition detection boss/player
    ...
    drawStatusText(context){
      ...
      context.shadowColor = 'black'
       ...
       if (this.gameOver){
            ...
            context.fillText('GAME OVER!', this.width * 0.1, this.height * 0.5);
            context.font = '20px Impact';
            context.fillText('press R to restart!', this.width * 0.4, this.height * 0.5 + 30);
       }
       context.restore();
    }
    newWave(){
